...
export class ResultadoEvaluacionController {
  ...
  @get('/resultados-evaluacion/count')
  @response(200, {
  ...
  @patch('/resultados-evaluacion/{id}')
  @response(204, {
